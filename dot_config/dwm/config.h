...
const char *spcmd1[] = {TERMINAL, "--class", TERMCLASS ",spterm", NULL };
const char *spcmd2[] = {TERMINAL, "--class", TERMCLASS ",spcalc", "-o", "font.size=16", "-e", "bc", "-lq", NULL };
...
static const char *notesmenu[] = { "wdmenu-notes", NULL };
static const char *sysmenu[] = { "wdmenu-sys", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY, 			XK_F1, 		   spawn, 				   SHCMD("wdmenu-cheatsheets") },
